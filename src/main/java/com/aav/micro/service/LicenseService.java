...
public class LicenseService {
		...
		public String createLicense(License license,
				...
				if (license != null) {
						license.setOrganizationId(organizationId);
						responseMessage =
										String.format(messageSource.getMessage("license.create.message",
		...
		public String updateLicense(License license, String organizationId) {
				...
				if (license != null) {
						license.setOrganizationId(organizationId);
						responseMessage =
										String.format(messageSource.getMessage("licence.update.message",
		...
		public String deleteLicense(String licenseId, String organizationId) {
				String responseMessage = null;
				responseMessage =
								String.format(messageSource.getMessage("licence.delete.message",
